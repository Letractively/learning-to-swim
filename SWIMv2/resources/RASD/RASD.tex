...
Con i seguenti statechart abbiamo controllato il flusso delle operazioni del sistema in alcuni casi specifici:
\begin{center}
\includegraphics[scale=0.75]{statechart/inviofeedback.png} \\
\caption{Invio di un feedback}
\end{center}
\clearpage
