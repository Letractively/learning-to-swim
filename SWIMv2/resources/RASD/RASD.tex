...
\large
\begin{flushleft}
\centerline{Teacher: Prof.ssa Raffaela Mirandola}
\end{flushleft}}
}
...
\title{{\includegraphics[scale=0.2]{polimi} \linebreak \Large SOFTWARE ENGINEERING 2 PROJECT ``SWIMv2''}}
\author{Emanuele Uliana \\ 799256 \and Gabriele Rufolo \\ 743695 \and Walter Rubino \\ 742519} %COMPLETATE 
