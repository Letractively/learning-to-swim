...
<div class="container">
  ...
  <span class="headtitle">Small World hypothesIs Machine<span id="headap">2</span></span>
    <ul class="dropdown">
    	...
    	if (isLogged)
    		out.write("<a href='#'><img src='images/ingranaggio.png'/></a><ul class='sub_menu'><li><a href='index.jsp'>Profilo</a></li><li><a href='amicizie.jsp'>Amici</a></li><!--li><a href='#'>Gestione</a><ul><li><a href='password.jsp'>Modifica password</a></li><li><a href='#'></a></li></ul></li--><li><a href='ability.jsp'>Abilit&agrave;</a></li><li><a href='messaggi.jsp'>Messaggi</a></li><li><a href='logout'>Logout</a></li></ul>");
    	else
